...
[Releases](https://github.com/RTCK-reina/Real-ESRGAN-GUI/releases) ページから、最新の Real-ESRGAN-GUI をダウンロードします。
...
不具合報告・機能要望は fork 側の Issues へお願いします。
https://github.com/RTCK-reina/Real-ESRGAN-GUI/issues

## fork 版リリース運用

この fork では GitHub Releases を配布導線として利用します。
- リリース作成時は `v<version>` タグ（例: `v1.2.0+rtck.1`）を作成
- Windows / macOS ビルド成果物を Release Assets に添付
- アプリ内更新チェックはこの fork の最新 Release を参照
